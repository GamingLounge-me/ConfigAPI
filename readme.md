[![](https://maven.gaminglounge.me/api/badge/latest/gaminglounge/me/gaminglounge/config-api?color=40c14a&name=Config%20API&prefix=v&filter=none:SNAPSHOT)](http://latest.maven.gl.me/config-api)
